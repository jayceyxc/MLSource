#!/usr/bin/env python3
# @Time    : 2018/10/4 3:47 PM
# @Author  : yuxuecheng
# @Contact : yuxuecheng@xinluomed.com
# @Site    : 
# @File    : boston_housing_price_logistic_regression.py
# @Software: PyCharm
# @Description 使用LinearRegression和SGDRegressor对波士顿房价进行回归预测
...
# 使用mean_absolute_error模块，并输出评估结果。
print('The mean absoluate error of SGDRegressor is', mean_absolute_error(y_test, sgdr_y_predict))
...
print('The mean squared error of distance-weighted KNeighorRegression:', mean_squared_error(y_test, dis_knr_y_predict))
print('The mean absoluate error of distance-weighted KNeighorRegression:', mean_absolute_error(y_test, dis_knr_y_predict))
